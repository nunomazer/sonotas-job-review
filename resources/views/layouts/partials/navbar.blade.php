<aside class="navbar navbar-vertical navbar-expand-lg navbar-transparent">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href="{{ route('home') }}">
                <img src="{{ mix('images/sonotas_logo_horizontal.png') }}" width="110" height="32"
                    alt="{{ config('app.name', 'Só Notas') }}" class="navbar-brand-image">
            </a>
        </h1>
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('vendas.list') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                @hasrole('sys-admin')
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('afiliados.list') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-binary-tree-2"
                                width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
