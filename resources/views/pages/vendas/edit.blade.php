            ...
            <form method="POST" action="{{ route('vendas.store') }}">
                ...
                <div class="row">
                    <div class="mb-3 col-12">
                        ...
                        <select class="form-select" required name="empresa_id">
                            ...
                            <option value="{{$empresa->id}}" {{ old('empresa_id', $venda->empresa_id ?? '') == $empresa->id ? 'selected' : '' }}>
                                {{$empresa->nome}}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-12 col-lg-3">
                        ...
                        <input type="date" class="form-control" name="data_transacao" required value="{{ old('data_transacao', (isset($venda) ? $venda->data_transacao->format('Y-m-d') : now()->format('Y-m-d'))) }}">
                    </div>

                    <div class="mb-3 col-12 col-lg-3">
                        <label class="form-label">Data planejada NF</label>
                        <input type="date" class="form-control" name="data_emissao_planejada" value="{{ old('data_transacao', $venda->data_transacao ?? '') }}">
                        <div class="form-text">
                        ...
                        <div class="row linhaItem">
                            <div class="input-group mb-3">
                                ...
                                <div class="col-3 col-md-2">
                                    <input type="number" step="0.01" class="form-control text-center ms-1 servico-qtde " style="text-overflow: ellipsis;" name="servico[{{$idx}}][qtde]" id="servico_qtde_{{$idx}}" value="{{$vendaItem->qtde}}" data-idx="{{$idx}}" placeholder="Qtde" required />
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-1 d-flex d-md-block align-items-center">
                                    <div class="input-group-append ms-1 text-center">
                                        <a id="removeRow" class="text-center">
                                            <svg style="margin-left:5px; color: #d63939" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="row">
                    <div class="mb-3 col-10">
                        ...
                        <textarea class="form-control" style="width: 100%; min-height: 80px; max-height:120px" name="info_adicional" maxlength="4000">{{old('info_adicional', $venda->info_adicional ?? '')}}</textarea>
                    </div>
                    <div class="mb-3 col-2">
                        <label for="name" class="form-label required">Valor total</label>
                        <input type="number" step="0.01" class="form-control" name="valor" id="valor" readonly="readonly" required value="{{ old('valor', $valor->valor ?? '0') }}">
            ...
            var html = `<div class="row linhaItem"> 
                    <div class="input-group mb-3">
                        ...
                        <div class="col-1 d-flex  align-items-center">
                                    <div class="input-group-append ms-1 text-center">
                                        <a id="removeRow" class="text-center">
                                            <svg style="margin-left:10px; color: #d63939" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                <line x1="4" y1="7" x2="20" y2="7"></line>
                                                <line x1="10" y1="11" x2="10" y2="17"></line>
                                                <line x1="14" y1="11" x2="14" y2="17"></line>
