                            ...
                            <table class="heading_block block-1" width="100%" border="0" cellpadding="0"
                                ...
                                <tr>
                                    <td class="pad" style="width:100%;text-align:center"><h1
                                            ...
                                            <span class="tinyMce-placeholder">Seja bem vindo(a)!</span></h1></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td class="pad">
                                        <div
                                            ...
                                            <p style="margin:0">Estamos contentes em ter você como nosso parceiro para emissão de notas!</p></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
